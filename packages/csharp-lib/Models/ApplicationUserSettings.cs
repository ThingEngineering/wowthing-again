...
public class ApplicationUserSettingsCharacters
{
    ...
    public List<string> DisabledNameTooltip { get; set; } = new();
}
...
public class ApplicationUserSettingsProfessions
{
    ...
    public bool FullConcentrationIsBad { get; set; } = true;
...
public class ApplicationUserSettingsView
{
    ...
    public Dictionary<string, string> ChoreFilters { get; set; } = new();
