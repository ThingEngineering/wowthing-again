...
namespace Wowthing.Lib.Migrations
{
    ...
    [Migration("20220805005744_Add_PlayerCharacterAddonData_MythicPlusSeasons_MythicPlusWeeks")]
    partial class Add_PlayerCharacterAddonData_MythicPlusSeasons_MythicPlusWeeks
    {
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Player.PlayerCharacterCurrency", b =>
                {
                    ...
                    b.ToTable("player_character_currency", (string)null);
                });
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Query.AccountTransmogQuery", b =>
                {
                    ...
                    b.ToTable("AccountTransmogQuery", null, t => t.ExcludeFromMigrations());
                });
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Query.AchievementCriteriaQuery", b =>
                {
                    ...
                    b.ToTable("AchievementCriteriaQuery", null, t => t.ExcludeFromMigrations());
                });
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Query.CompletedAchievementsQuery", b =>
                {
                    ...
                    b.ToTable("CompletedAchievementsQuery", null, t => t.ExcludeFromMigrations());
                });
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Query.GoldSnapshotQuery", b =>
                {
                    ...
                    b.ToTable("GoldSnapshotQuery", null, t => t.ExcludeFromMigrations());
                });
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Query.LatestGoldSnapshotQuery", b =>
                {
                    ...
                    b.ToTable("LatestGoldSnapshotQuery", null, t => t.ExcludeFromMigrations());
                });
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Query.MountQuery", b =>
                {
                    ...
                    b.ToTable("MountQuery", null, t => t.ExcludeFromMigrations());
                });
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Query.StatisticsQuery", b =>
                {
                    ...
                    b.ToTable("StatisticsQuery", null, t => t.ExcludeFromMigrations());
                });
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Wow.WowTitle", b =>
                {
                    ...
                    b.ToTable("wow_title", (string)null);
                });
