...
namespace Wowthing.Lib.Migrations
{
    ...
    [Migration("20260704214654_Add_PlayerCharacterAchievements_CompressedCriteriaIds")]
    partial class Add_PlayerCharacterAchievements_CompressedCriteriaIds
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasIndex("ApiKey")
                        .IsUnique()
                        .HasDatabaseName("ix_asp_net_users_api_key");
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.AuditLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Global.GlobalDailies", b =>
                {
                    ...
                    b.PrimitiveCollection<List<int>>("QuestExpires")
                        .HasColumnType("integer[]")
                        .HasColumnName("quest_expires");

                    b.PrimitiveCollection<List<int>>("QuestIds")
                        .HasColumnType("integer[]")
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Player.PlayerAccountAchievements", b =>
                {
                    ...
                    b.Property<byte[]>("CompressedAchievementIds")
                        .HasColumnType("bytea")
                        .HasColumnName("compressed_achievement_ids");

                    b.HasKey("AccountId")
                        .HasName("pk_player_account_achievements");

                    b.ToTable("player_account_achievements", (string)null);
                });
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Player.PlayerAccountAddonData", b =>
                {
                    ...
                    b.Property<Dictionary<int, List<int>>>("Decor")
                        .HasColumnType("jsonb")
                        .HasColumnName("decor");

                    b.Property<DateTime>("DecorScannedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("decor_scanned_at");
                    ...
                    b.PrimitiveCollection<List<int>>("Illusions")
                        .HasColumnType("integer[]")
                        .HasColumnName("illusions");

                    b.PrimitiveCollection<List<int>>("Quests")
                        .HasColumnType("integer[]")
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Player.PlayerAccountMounts", b =>
                {
                    b.Property<int>("AccountId")
                        .HasColumnType("integer")
                        .HasColumnName("account_id");

                    b.PrimitiveCollection<List<int>>("MountIds")
                        .HasColumnType("integer[]")
                    ...
                    b.HasKey("AccountId")
                        .HasName("pk_player_account_mounts");

                    b.ToTable("player_account_mounts", (string)null);
                });
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Player.PlayerAccountToys", b =>
                {
                    ...
                    b.PrimitiveCollection<List<int>>("ToyIds")
                        .HasColumnType("integer[]")
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Player.PlayerCharacter", b =>
                {
                    ...
                    b.HasIndex("CharacterId", "LastSeenAddon")
                        .HasDatabaseName("ix_player_character_character_id_last_seen_addon")
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Player.PlayerCharacterAchievements", b =>
                {
                    ...
                    b.PrimitiveCollection<List<bool>>("CriteriaCompleted")
                        .HasColumnType("boolean[]")
                        .HasColumnName("criteria_completed");

                    b.PrimitiveCollection<List<int>>("CriteriaIds")
                        .HasColumnType("integer[]")
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Player.PlayerCharacterAddonData", b =>
                {
                    ...
                    b.Property<DateTime>("CurrenciesScannedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("currencies_scanned_at");

                    b.Property<DateTime>("CurrenciesTransferredAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("currencies_transferred_at");

                    b.Property<string>("CurrentLocation")
                        .HasColumnType("text")
                        .HasColumnName("current_location");

                    b.Property<DateTime>("DailyReset")
                        .HasColumnType("timestamp with time zone")
                    ...
                    b.Property<Dictionary<int, int>>("HighestItemLevel")
                        .HasColumnType("jsonb")
                        .HasColumnName("highest_item_level");

                    b.PrimitiveCollection<List<int>>("KnownSpells")
                        .HasColumnType("integer[]")
                        .HasColumnName("known_spells");
                    ...
                    b.Property<DateTime>("PatronOrdersScannedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("patron_orders_scanned_at");
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Player.PlayerCharacterAddonMounts", b =>
                {
                    ...
                    b.PrimitiveCollection<List<int>>("Mounts")
                        .HasColumnType("integer[]")
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Player.PlayerCharacterAddonQuests", b =>
                {
                    ...
                    b.PrimitiveCollection<List<int>>("CompletedQuests")
                        .HasColumnType("integer[]")
                        .HasColumnName("completed_quests");

                    b.Property<DateTime>("CompletedQuestsScannedAt")
                        .HasColumnType("timestamp with time zone")
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Player.PlayerCharacterItem", b =>
                {
                    ...
                    b.PrimitiveCollection<List<short>>("BonusIds")
                        .HasColumnType("smallint[]")
                    ...
                    b.PrimitiveCollection<List<int>>("Gems")
                        .HasColumnType("integer[]")
                        .HasColumnName("gems");
                    ...
                    b.Property<Dictionary<int, int>>("Modifiers")
                        .HasColumnType("jsonb")
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Player.PlayerCharacterQuests", b =>
                {
                    ...
                    b.PrimitiveCollection<List<int>>("CompletedIds")
                        .HasColumnType("integer[]")
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Player.PlayerCharacterReputations", b =>
                {
                    ...
                    b.PrimitiveCollection<List<int>>("ExtraReputationIds")
                        .HasColumnType("integer[]")
                        .HasColumnName("extra_reputation_ids");

                    b.PrimitiveCollection<List<int>>("ExtraReputationValues")
                        .HasColumnType("integer[]")
                    ...
                    b.PrimitiveCollection<List<int>>("ReputationIds")
                        .HasColumnType("integer[]")
                        .HasColumnName("reputation_ids");

                    b.PrimitiveCollection<List<int>>("ReputationValues")
                        .HasColumnType("integer[]")
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Player.PlayerCharacterShadowlands", b =>
                {
                    ...
                    b.PrimitiveCollection<List<int>>("ConduitIds")
                        .HasColumnType("integer[]")
                        .HasColumnName("conduit_ids");

                    b.PrimitiveCollection<List<int>>("ConduitRanks")
                        .HasColumnType("integer[]")
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Player.PlayerCharacterStatistics", b =>
                {
                    ...
                    b.PrimitiveCollection<List<string>>("StatisticDescriptions")
                        .HasColumnType("text[]")
                        .HasColumnName("statistic_descriptions");

                    b.PrimitiveCollection<List<int>>("StatisticIds")
                        .HasColumnType("integer[]")
                        .HasColumnName("statistic_ids");

                    b.PrimitiveCollection<List<int>>("StatisticQuantities")
                        .HasColumnType("integer[]")
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Player.PlayerCharacterTransmog", b =>
                {
                    ...
                    b.PrimitiveCollection<List<int>>("IllusionIds")
                        .HasColumnType("integer[]")
                        .HasColumnName("illusion_ids");

                    b.PrimitiveCollection<List<int>>("TransmogIds")
                        .HasColumnType("integer[]")
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Player.PlayerCharacterWeekly", b =>
                {
                    ...
                    b.Property<short>("DelveGilded")
                        .HasColumnType("smallint")
                        .HasColumnName("delve_gilded");

                    b.PrimitiveCollection<List<int>>("DelveLevels")
                        .HasColumnType("integer[]")
                        .HasColumnName("delve_levels");

                    b.PrimitiveCollection<List<string>>("DelveMaps")
                        .HasColumnType("text[]")
                        .HasColumnName("delve_maps");

                    b.Property<int>("DelveWeek")
                        .HasColumnType("integer")
                        .HasColumnName("delve_week");
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Player.PlayerGuild", b =>
                {
                    ...
                    b.Property<Dictionary<int, PlayerGuildTab>>("Tabs")
                        .HasColumnType("jsonb")
                        .HasColumnName("tabs");
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Player.PlayerWarbankItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_player_warbank_item");

                    b.HasIndex("UserId", "ItemId")
                        .HasDatabaseName("ix_player_warbank_item_user_id_item_id");

                    b.ToTable("player_warbank_item", (string)null);
                });
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Query.LatestPlayerAccountGoldSnapshotQuery", b =>
                {
                    b.Property<int>("AccountId")
                        .HasColumnType("integer")
                        .HasColumnName("account_id");
                    ...
                    b.ToTable("LatestPlayerAccountGoldSnapshotQuery", null, t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });

            modelBuilder.Entity("Wowthing.Lib.Models.Query.LatestUserGoldSnapshotQuery", b =>
                {
                    b.Property<int>("Gold")
                        .HasColumnType("integer")
                        .HasColumnName("gold");
                    ...
                    b.ToTable("LatestUserGoldSnapshotQuery", null, t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Query.MountQuery", b =>
                {
                    b.PrimitiveCollection<List<int>>("AddonMounts")
                        .HasColumnType("integer[]")
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Query.PlayerAccountGoldSnapshotQuery", b =>
                {
                    ...
                    b.ToTable("PlayerAccountGoldSnapshotQuery", null, t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Query.UserGoldSnapshotQuery", b =>
                {
                    b.Property<int>("TotalGold")
                        .HasColumnType("integer")
                        .HasColumnName("total_gold");
                    ...
                    b.ToTable("UserGoldSnapshotQuery", null, t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.QueuedJob", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_queued_job");

                    b.HasIndex("Priority")
                        .HasDatabaseName("ix_queued_job_priority")
                        .HasFilter("started_at IS NULL");

                    b.HasIndex("Priority", "Type", "DataHash")
                        .IsUnique()
                        .HasDatabaseName("ix_queued_job_priority_type_data_hash");

                    b.ToTable("queued_job", (string)null);
                });
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.User.UserAddonData", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("WarbankGoldUpdatedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("warbank_gold_updated_at");
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.User.UserBulkData", b =>
                {
                    ...
                    b.Property<DateTime>("HeirloomsUpdatedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("heirlooms_updated_at");

                    b.PrimitiveCollection<List<short>>("MountIds")
                        .HasColumnType("smallint[]")
                        .HasColumnName("mount_ids");

                    b.Property<DateTime>("MountsUpdatedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("mounts_updated_at");

                    b.Property<Dictionary<long, PlayerAccountPetsPet>>("Pets")
                        .HasColumnType("jsonb")
                        .HasColumnName("pets");

                    b.Property<DateTime>("PetsUpdatedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("pets_updated_at");

                    b.PrimitiveCollection<List<short>>("ToyIds")
                        .HasColumnType("smallint[]")
                        .HasColumnName("toy_ids");

                    b.Property<DateTime>("ToysUpdatedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("toys_updated_at");

                    b.PrimitiveCollection<List<int>>("TransmogIds")
                        .HasColumnType("integer[]")
                        .HasColumnName("transmog_ids");

                    b.Property<DateTime>("TransmogsUpdatedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("transmogs_updated_at");

                    b.HasKey("UserId")
                        .HasName("pk_user_bulk_data");

                    b.ToTable("user_bulk_data", (string)null);
                });
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.User.UserCache", b =>
                {
                    ...
                    b.PrimitiveCollection<List<int>>("AppearanceIds")
                        .HasColumnType("integer[]")
                        .HasColumnName("appearance_ids");

                    b.PrimitiveCollection<List<string>>("AppearanceSources")
                        .HasColumnType("text[]")
                    ...
                    b.PrimitiveCollection<List<short>>("IllusionIds")
                        .HasColumnType("smallint[]")
                        .HasColumnName("illusion_ids");
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.WorldQuestAggregate", b =>
                {
                    ...
                    b.HasKey("Region", "ZoneId", "QuestId")
                        .HasName("pk_world_quest_aggregate");

                    b.ToTable("world_quest_aggregate", (string)null);
                });
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Wow.WowAuction", b =>
                {
                    ...
                    b.PrimitiveCollection<List<int>>("BonusIds")
                        .HasColumnType("integer[]")
                        .HasColumnName("bonus_ids");
                    ...
                    b.PrimitiveCollection<List<short>>("ModifierTypes")
                        .HasColumnType("smallint[]")
                        .HasColumnName("modifier_types");

                    b.PrimitiveCollection<List<int>>("ModifierValues")
                        .HasColumnType("integer[]")
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Wow.WowAuctionCommodityDaily", b =>
                {
                    b.Property<short>("Region")
                        .HasColumnType("smallint")
                        .HasColumnName("region");
                    ...
                    b.PrimitiveCollection<List<int>>("AvgData")
                        .HasColumnType("integer[]")
                        .HasColumnName("avg_data");

                    b.Property<int>("ListedMax")
                        .HasColumnType("integer")
                        .HasColumnName("listed_max");

                    b.Property<int>("ListedMin")
                        .HasColumnType("integer")
                        .HasColumnName("listed_min");

                    b.PrimitiveCollection<List<int>>("MaxData")
                        .HasColumnType("integer[]")
                        .HasColumnName("max_data");

                    b.PrimitiveCollection<List<int>>("MinData")
                        .HasColumnType("integer[]")
                        .HasColumnName("min_data");

                    b.HasKey("Region", "ItemId", "Date")
                        .HasName("pk_wow_auction_commodity_daily");

                    b.ToTable("wow_auction_commodity_daily", (string)null);
                });
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Wow.WowAuctionCommodityHourly", b =>
                {
                    ...
                    b.PrimitiveCollection<List<int>>("Data")
                        .HasColumnType("integer[]")
                        .HasColumnName("data");
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Wow.WowCampaign", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.PrimitiveCollection<List<int>>("QuestLineIds")
                        .HasColumnType("integer[]")
                        .HasColumnName("quest_line_ids");

                    b.HasKey("Id")
                        .HasName("pk_wow_campaign");

                    b.ToTable("wow_campaign", (string)null);
                });

            modelBuilder.Entity("Wowthing.Lib.Models.Wow.WowChallengeDungeon", b =>
                {
                    b.Property<short>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smallint")
                    ...
                    b.PrimitiveCollection<List<short>>("TimerBreakpoints")
                        .HasColumnType("smallint[]")
                        .HasColumnName("timer_breakpoints");

                    b.HasKey("Id")
                        .HasName("pk_wow_challenge_dungeon");

                    b.ToTable("wow_challenge_dungeon", (string)null);
                });
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Wow.WowCurrency", b =>
                {
                    ...
                    b.Property<short>("RechargeAmount")
                        .HasColumnType("smallint")
                        .HasColumnName("recharge_amount");

                    b.Property<long>("RechargeInterval")
                        .HasColumnType("bigint")
                        .HasColumnName("recharge_interval");

                    b.Property<short>("TransferPercent")
                        .HasColumnType("smallint")
                        .HasColumnName("transfer_percent");
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Wow.WowDecor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_wow_decor");

                    b.ToTable("wow_decor", (string)null);
                });
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Wow.WowHoliday", b =>
                {
                    ...
                    b.Property<short>("DescriptionId")
                        .HasColumnType("smallint")
                        .HasColumnName("description_id");

                    b.PrimitiveCollection<List<short>>("Durations")
                        .HasColumnType("smallint[]")
                    ...
                    b.PrimitiveCollection<List<DateTime>>("StartDates")
                        .HasColumnType("timestamp with time zone[]")
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Wow.WowItem", b =>
                {
                    ...
                    b.PrimitiveCollection<int[]>("CompletesQuestIds")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer[]")
                        .HasDefaultValue(new int[0])
                        .HasColumnName("completes_quest_ids");

                    b.Property<short>("ContainerSlots")
                        .HasColumnType("smallint")
                        .HasColumnName("container_slots");

                    b.Property<short>("CraftingQuality")
                        .HasColumnType("smallint")
                        .HasColumnName("crafting_quality");
                    ...
                    b.PrimitiveCollection<short[]>("Sockets")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smallint[]")
                    ...
                    b.PrimitiveCollection<int[]>("TeachesDecorIds")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer[]")
                        .HasDefaultValue(new int[0])
                        .HasColumnName("teaches_decor_ids");

                    b.PrimitiveCollection<int[]>("TeachesSpellIds")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer[]")
                        .HasDefaultValue(new int[0])
                        .HasColumnName("teaches_spell_ids");

                    b.PrimitiveCollection<int[]>("TeachesTransmogIllusionIds")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer[]")
                        .HasDefaultValue(new int[0])
                        .HasColumnName("teaches_transmog_illusion_ids");

                    b.PrimitiveCollection<int[]>("TeachesTransmogSetIds")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer[]")
                        .HasDefaultValue(new int[0])
                        .HasColumnName("teaches_transmog_set_ids");
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Wow.WowItemEffectV2", b =>
                {
                    ...
                    b.PrimitiveCollection<List<int>>("ItemEffectIds")
                        .HasColumnType("integer[]")
                        .HasColumnName("item_effect_ids");
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Wow.WowJournalInstance", b =>
                {
                    b.Property<short>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smallint")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_wow_journal_instance");

                    b.ToTable("wow_journal_instance", (string)null);
                });
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Wow.WowQuestLine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_wow_quest_line");

                    b.ToTable("wow_quest_line", (string)null);
                });
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Wow.WowReputation", b =>
                {
                    ...
                    b.PrimitiveCollection<List<int>>("BaseValues")
                        .HasColumnType("integer[]")
                        .HasColumnName("base_values");

                    b.Property<short>("Expansion")
                        .HasColumnType("smallint")
                        .HasColumnName("expansion");

                    b.PrimitiveCollection<List<int>>("MaxValues")
                        .HasColumnType("integer[]")
                    ...
                    b.Property<int>("ParagonQuestId")
                        .HasColumnType("integer")
                        .HasColumnName("paragon_quest_id");

                    b.Property<int>("ParagonThreshold")
                        .HasColumnType("integer")
                        .HasColumnName("paragon_threshold");

                    b.Property<short>("ParentId")
                        .HasColumnType("smallint")
                        .HasColumnName("parent_id");

                    b.Property<short>("RenownCurrencyId")
                        .HasColumnType("smallint")
                        .HasColumnName("renown_currency_id");
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Wow.WowReputationTier", b =>
                {
                    ...
                    b.PrimitiveCollection<int[]>("MinValues")
                        .HasColumnType("integer[]")
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Wow.WowTransmogSet", b =>
                {
                    ...
                    b.PrimitiveCollection<List<int>>("ItemModifiedAppearanceIds")
                        .HasColumnType("integer[]")
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Wow.WowWorldQuest", b =>
                {
                    ...
                    b.PrimitiveCollection<List<int>>("NeedQuestIds")
                        .HasColumnType("integer[]")
                    ...
                    b.PrimitiveCollection<List<int>>("SkipQuestIds")
                        .HasColumnType("integer[]")
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Player.PlayerAccountAchievements", b =>
                {
                    b.HasOne("Wowthing.Lib.Models.Player.PlayerAccount", "Account")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_player_account_achievements_player_account_account_id");
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Player.PlayerAccountMounts", b =>
                {
                    b.HasOne("Wowthing.Lib.Models.Player.PlayerAccount", "Account")
                        .WithOne("Mounts")
                        .HasForeignKey("Wowthing.Lib.Models.Player.PlayerAccountMounts", "AccountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_player_account_mounts_player_account_account_id");
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Player.PlayerWarbankItem", b =>
                {
                    b.HasOne("Wowthing.Lib.Models.ApplicationUser", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_player_warbank_item_application_user_user_id");
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.User.UserBulkData", b =>
                {
                    b.HasOne("Wowthing.Lib.Models.ApplicationUser", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_user_bulk_data_application_user_user_id");
