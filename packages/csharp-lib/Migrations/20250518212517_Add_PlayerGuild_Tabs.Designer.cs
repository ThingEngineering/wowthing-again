...
namespace Wowthing.Lib.Migrations
{
    ...
    [Migration("20250518212517_Add_PlayerGuild_Tabs")]
    partial class Add_PlayerGuild_Tabs
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Player.PlayerCharacterAddonData", b =>
                {
                    ...
                    b.Property<List<int>>("KnownSpells")
                        .HasColumnType("integer[]")
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Player.PlayerCharacterAddonQuests", b =>
                {
                    ...
                    b.Property<List<int>>("CompletedQuests")
                        .HasColumnType("integer[]")
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Player.PlayerCharacterWeekly", b =>
                {
                    ...
                    b.Property<List<int>>("DelveLevels")
                        .HasColumnType("integer[]")
                        .HasColumnName("delve_levels");

                    b.Property<List<string>>("DelveMaps")
                        .HasColumnType("text[]")
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Wow.WowAuctionCommodityDaily", b =>
                {
                    ...
                    b.Property<List<int>>("MaxData")
                        .HasColumnType("integer[]")
                        .HasColumnName("max_data");

                    b.Property<List<int>>("MinData")
                        .HasColumnType("integer[]")
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Wow.WowCampaign", b =>
                {
                    ...
                    b.Property<List<int>>("QuestLineIds")
                        .HasColumnType("integer[]")
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Wow.WowItem", b =>
                {
                    ...
                    b.Property<int[]>("CompletesQuestIds")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer[]")
                    ...
                    b.Property<int[]>("TeachesSpellIds")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer[]")
                        .HasDefaultValue(new int[0])
                    ...
                    b.Property<int[]>("TeachesTransmogSetIds")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer[]")
                        .HasDefaultValue(new int[0])
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Wow.WowItemEffectV2", b =>
                {
                    ...
                    b.Property<List<int>>("ItemEffectIds")
                        .HasColumnType("integer[]")
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Wow.WowReputation", b =>
                {
                    ...
                    b.Property<List<int>>("BaseValues")
                        .HasColumnType("integer[]")
