...
namespace Wowthing.Lib.Migrations
{
    ...
    [Migration("20230803045928_Add_WowProfessionRecipeItem")]
    partial class Add_WowProfessionRecipeItem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Query.MissingTransmogByAppearanceIdQuery", b =>
                {
                    b.Property<int>("AppearanceId")
                        .HasColumnType("integer")
                        .HasColumnName("appearance_id");

                    b.Property<int[]>("BonusIds")
                        .HasColumnType("integer[]")
                        .HasColumnName("bonus_ids");
                    ...
                    b.ToTable("MissingTransmogByAppearanceIdQuery", null, t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.Wow.WowProfessionRecipeItem", b =>
                {
                    ...
                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("SkillLineAbilityId"));
