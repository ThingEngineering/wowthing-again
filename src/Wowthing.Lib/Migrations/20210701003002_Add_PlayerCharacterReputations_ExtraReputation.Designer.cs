...
namespace Wowthing.Lib.Migrations
{
    ...
    [Migration("20210701003002_Add_PlayerCharacterReputations_ExtraReputation")]
    partial class Add_PlayerCharacterReputations_ExtraReputation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.PlayerCharacterCurrencies", b =>
                {
                    b.Property<int>("CharacterId")
                        .HasColumnType("integer")
                        .HasColumnName("character_id");
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.PlayerCharacterLockouts", b =>
                {
                    b.Property<int>("CharacterId")
                        .HasColumnType("integer")
                        .HasColumnName("character_id");
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.PlayerCharacterProfessions", b =>
                {
                    b.Property<int>("CharacterId")
                        .HasColumnType("integer")
                        .HasColumnName("character_id");
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.PlayerCharacterCurrencies", b =>
                {
                    b.HasOne("Wowthing.Lib.Models.PlayerCharacter", "Character")
                        .WithOne("Currencies")
                        .HasForeignKey("Wowthing.Lib.Models.PlayerCharacterCurrencies", "CharacterId")
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.PlayerCharacterLockouts", b =>
                {
                    b.HasOne("Wowthing.Lib.Models.PlayerCharacter", "Character")
                        .WithOne("Lockouts")
                        .HasForeignKey("Wowthing.Lib.Models.PlayerCharacterLockouts", "CharacterId")
