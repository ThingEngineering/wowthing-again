...
namespace Wowthing.Lib.Migrations
{
    ...
    [Migration("20201119063008_Rename_WowAccount_and_WowCharacter")]
    partial class Rename_WowAccount_and_WowCharacter
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.UserAccount", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnName("id")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("UserId")
                        .HasName("ix_user_account_user_id");

                    b.ToTable("user_account");
                });

            modelBuilder.Entity("Wowthing.Lib.Models.UserCharacter", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnName("id")
                        .HasColumnType("bigint");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_user_character");

                    b.HasIndex("AccountId")
                        .HasName("ix_user_character_account_id");
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.UserCharacter", b =>
                {
                    b.HasOne("Wowthing.Lib.Models.UserAccount", "Account")
                        .WithMany("Characters")
                        .HasForeignKey("AccountId")
                        .HasConstraintName("fk_user_character_user_account_account_id")
