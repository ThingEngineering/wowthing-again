...
namespace Wowthing.Lib.Migrations
{
    ...
    [Migration("20201123064720_Add_PlalyerCharacter_DelayHours")]
    partial class Add_PlalyerCharacter_DelayHours
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.PlayerCollections", b =>
                {
                    b.Property<long>("UserId")
                        .HasColumnName("user_id")
                        .HasColumnType("bigint");
                    ...
                    b.Property<List<int>>("Pets")
                        .HasColumnName("pets")
                        .HasColumnType("integer[]");

                    b.Property<List<int>>("Toys")
                        .HasColumnName("toys")
                        .HasColumnType("integer[]");

                    b.HasKey("UserId")
                        .HasName("pk_player_collections");

                    b.ToTable("player_collections");
                });

            modelBuilder.Entity("Wowthing.Lib.Models.Query.CharacterQuery", b =>
                {
            ...
            modelBuilder.Entity("Wowthing.Lib.Models.PlayerCollections", b =>
                {
                    b.HasOne("Wowthing.Lib.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .HasConstraintName("fk_player_collections_users_user_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
