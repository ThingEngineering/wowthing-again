...
const dungeonMap: Dictionary<Dungeon> = {
    ...
    247: new Dungeon(247, 'The MOTHERLODE!!', 'ML', 'dungeon_the_motherlode', 0),
    248: new Dungeon(248, 'Waycrest Manor', 'WM', 'dungeon_waycrest_manor', 0),
    249: new Dungeon(249, "King's Rest", 'KR', 'dungeon_kings_rest', 0),
    250: new Dungeon(250, 'Temple of Sethraliss', 'ToS', 'dungeon_temple_of_sethraliss', 0),
    251: new Dungeon(251, 'The Underrot', 'UR', 'dungeon_the_underrot', 0),
    252: new Dungeon(252, 'Shrine of the Storm', 'SoS', 'dungeon_shrine_of_the_storm', 0),
    353: new Dungeon(353, 'Siege of Boralus', 'SoB', 'dungeon_siege_of_boralus', 0),
    369: new Dungeon(369, 'Operation: Mechagon - Junkyard', 'OMJ', 'dungeon_operation_mechagon_junkyard', 0),
    370: new Dungeon(370, 'Operation: Mechagon - Workshop', 'OMW', 'dungeon_operation_mechagon_workshop', 0),

    // Shadowlands
    375: new Dungeon(375, 'Mists of Tirna Scithe', 'MoTS', 'dungeon_mists_of_tirna_scithe', 30),
    376: new Dungeon(376, 'The Necrotic Wake', 'NW', 'dungeon_the_necrotic_wake', 36),
    377: new Dungeon(377, 'De Other Side', 'DOS', 'dungeon_de_other_side', 43),
    378: new Dungeon(378, 'Halls of Atonement', 'HoA', 'dungeon_halls_of_atonement', 31),
    379: new Dungeon(379, 'Plaguefall', 'PF', 'dungeon_plaguefall', 38),
    380: new Dungeon(380, 'Sanguine Depths', 'SD', 'dungeon_sanguine_depths', 41),
    381: new Dungeon(381, 'Spires of Ascension', 'SoA', 'dungeon_spires_of_ascension', 39),
    382: new Dungeon(382, 'Theater of Pain', 'ToP', 'dungeon_theater_of_pain', 37),
}
