...
export const midnightBlacksmithing: TaskProfession = {
    id: Profession.Blacksmithing,
    subProfessionId: 2907,
    orderQuest: {
        itemId: 263455, // Thalassian Blacksmith's Journal
        questId: 93691,
    },
    treatiseQuest: {
...
export const warWithinBlacksmithing: TaskProfession = {
    ...
    bookQuests: [
        ...
        {
            itemId: 232500, // Undermine Treatise on Blacksmithing
            questId: 85735,
            source: 'UM 16',
            costs: [{ amount: 50, itemId: 210814 }], // Artisan's Acuity
        },
        {
            itemId: 235864, // Ethereal Tome of Blacksmithing Knowledge
            questId: 87266,
            source: 'TV 12',
            costs: [{ amount: 50, itemId: 210814 }], // Artisan's Acuity
        },
