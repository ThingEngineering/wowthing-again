...
export class StaticDataReputationCategory {
    ...
    constructor(
        ...
        this.reputations = reputationArrays.map((repGroup) =>
            repGroup.map((repSet) => new StaticDataReputationSet(...repSet)),
        );
    }
}
export type StaticDataReputationCategoryArray = ConstructorParameters<
    typeof StaticDataReputationCategory
>;
...
export type StaticDataReputationReputationArray = ConstructorParameters<
    typeof StaticDataReputationReputation
>;
...
export type StaticDataReputationRewardArray = ConstructorParameters<
    typeof StaticDataReputationReward
>;
