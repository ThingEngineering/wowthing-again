...
>
    {#if reputation.both}
        <div class="split-icon-no">
            <WowthingImage name={reputation.both.icon} size={40} border={2} />
        </div>
    {:else if reputation.alliance && reputation.horde}
        <div class="split-icon-yes">
            <WowthingImage name={reputation.alliance.icon} size={40} border={2} />
            <WowthingImage name={reputation.horde.icon} size={40} border={2} />
        </div>
