...
//         const charTask = new LazyCharacterChoreTask(choreTask.key, undefined);
...
//             if (
//                 charTask.quest &&
//                 (charTask.status === QuestStatus.Completed || forcedReset[choreTask.key]) &&
...
//             }
//         } else {
//             charTask.quest = charQuests?.progressQuestByKey?.get(choreTask.key);
//             if (charTask.quest) {
...
//         if (!accountTasks[choreTask.key]?.status) {
...
//                 }
//             }
//             accountTasks[choreTask.key] = bestTask;
//         }
//         return accountTasks[choreTask.key];
//     };
...
//                     if (
//                         disabledChores.indexOf(choreTask.key) >= 0 &&
...
//                                     const dropKey = choreTask.key.replace(
//                                         '#',
//                                         (index + 1).toString()
//                                     );
//                                     const progressQuest =
...
//                         if (charTask.statusTexts.length === 0) {
//                             needCount = choreTask.name.match(
