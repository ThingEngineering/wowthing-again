...
export class ManualDataStore extends WritableFancyStore<ManualData> {
    ...
    initialize(data: ManualData): void {
        ...
        data.customizationCategories = data.rawCustomizationCategories.map((categories) =>
            categories === null
                ? null
    ...
    private fixCollectionSets(allSets: ManualDataSetCategoryArray[][]): ManualDataSetCategory[][] {
