...
public class RedisStaticData
{
    ...
    public Dictionary<string, int[]> EnchantmentStrings { get; set; }
    public Dictionary<int, List<int>> EnchantmentValues { get; set; }
    ...
    public List<OutProfession> RawProfessions { get; set; }
    public List<WowRealm> RawRealms { get; set; }
    public Dictionary<short, int[]> ReagentCategories { get; set; }
    ...
    public StaticQuestLine[] RawQuestLines { get; set; }
